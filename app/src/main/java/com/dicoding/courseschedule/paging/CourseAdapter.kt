...
class CourseAdapter(private val clickListener: (Course) -> Unit) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CourseViewHolder {
        val viewItem = LayoutInflater.from(parent.context).inflate(R.layout.item_course, parent, false)
        return CourseViewHolder(viewItem)
    }

    override fun onBindViewHolder(holder: CourseViewHolder, position: Int) {
        val courseHolder = getItem(position) as Course
        holder.bind(courseHolder, clickListener)
